// app/components/FreelancerForm.tsx
'use client'
...
const FreelancerForm: React.FC<FreelancerFormProps> = ({ isOpen, onClose, user, onSuccess }) => {
    const [formData, setFormData] = useState({
        name: user.name, // Pre-fill with user's name but allow editing
        description: '',
    });
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl max-w-2xl w-full p-6 relative max-h-[90vh] overflow-y-auto">
                ...
                <div className="text-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Add Yourself as Freelancer</h2>
                    <p className="text-gray-600">Create your freelancer profile to start receiving bookings</p>
                </div>
